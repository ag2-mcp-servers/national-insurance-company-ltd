...
class CertificateParameters(BaseModel):
    customer_Id: str = Field(..., description='Customer No', examples=['9520949605'])
    policy_Number: str = Field(
        ..., description='Policy Number', examples=['500100501910002284']
    )
    policy_StartDate: str = Field(
        ..., description='Policy Start Date', examples=['06/03/2020']
    )
